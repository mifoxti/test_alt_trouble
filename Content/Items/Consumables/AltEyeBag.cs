using test_alt_trouble.Content.NPCs.AltEye;
using Terraria;
using Terraria.GameContent.ItemDropRules;
using Terraria.ID;
using Terraria.ModLoader;
using test_alt_trouble.Items;
using test_alt_trouble.Items.Placeable.Furniture;

namespace test_alt_trouble.Content.Items.Consumables
{
    ...
    public class MinionBossBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot) {
            ...
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<AltWorckbench>(), 7));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<AltSword>(), 1, 12, 16));
