using test_alt_trouble.Common.Systems;
using test_alt_trouble.Content.BossBars;
using test_alt_trouble.Items;
using test_alt_trouble.Items.Armor.Vanity;
using test_alt_trouble.Items.Consumables;
using test_alt_trouble.Content.Pets.AltBossPet;
using test_alt_trouble.Content.Projectiles;
...
namespace ExampleMod.Content.NPCs.AltEye
{
	...
	public class MinionBossBody : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			// Custom boss bar
			NPC.BossBar = ModContent.GetInstance<AltEyeBossBar>();
